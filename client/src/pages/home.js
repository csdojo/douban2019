...
class Home extends Component {
    ...
    inTheaterMovie = () => {
        ...
        var targetUrl = 'https://api.douban.com/v2/movie/us_box'
    ...
    render() {
        ...
        return (
            <div>
                                                    ...
                                                    <div className="col-12" key={movie.id}>
                                                        <div className="shadowbox">
                                                            ...
                                                            <div className="card border-light">
                                                                ...
                                                                <img className="movieImage" src={movie.images} alt={movie.title} referrerpolicy="never" className="" />
                                                                <div >
                                                                    ...
                                                                    <Button type="primary" className="ant-btn ant-btn-primary">
                                                                        <a className="btnA" href="https://www.amctheatres.com/" target="_blank">选座购票</a>
                                                                    </Button>
                ...
                <span className="salute">💌 Salute to Douban.com / 2018-2019 Made by 
                <a className="dojoA" href="https://github.com/csdojo" target="_blank">DOJO9</a>
                </span>
                </div>
                </div>
            </div>
