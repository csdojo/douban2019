    ...
    <div>
      ...
      <div className="row largelogorow">
        <div className="container">
          ...
          <a href="https://movie.douban.com/annual/2018?source=movie_navigation" target="_blank" rel="noopener noreferrer" className="movieoftheyear"><img className="douban2019" src={image} alt="" /></a>
        </div>
      </div>
